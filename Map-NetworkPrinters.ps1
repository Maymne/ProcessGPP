...
#Look up the Id and Domain from a computer with RSAT and replace the placeholders below
...
#Some drivers may require a manual administrative install, so we skip installing the printer if the driver hasn't been pre-loaded yet
#Some samples are included, but the list can be adjusted as needed
